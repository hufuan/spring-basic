...
import com.pancm.util.UserGenerator;
...
public class KafkaProducerTest2 implements Runnable {
	...
	public KafkaProducerTest2(String topicName) {
		...
		props.put("bootstrap.servers", "sh-r510-03-vm1:9092");
	...
	public void run() {
		...
		try {
			for(;;) {
				User usr = userGenerator.getUser();
				String messageStr= JSON.toJSONString(usr);
	...
	public static void main(String args[]) {
		KafkaProducerTest2 test = new KafkaProducerTest2("TEST_01");
