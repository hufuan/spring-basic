...
//	    private static String indexName = "userindex2";  
        ...
        private static String elasticIps="http://sh-r510-03-vm1:9200";
//	    private static String elasticIps="http://127.0.0.1:9200";
	    ...
	    public static void serach1() {
			System.out.println("serach1 begin...");
			String query ="工程师";
			try {
			...
			System.out.println("serach1 end");
		}
	    ...
	    public static void serach2() {
			System.out.println("serach2 begin...");
			try {
				SearchSourceBuilder searchSourceBuilder = new SearchSourceBuilder(); 
			...
			System.out.println("serach2 end");
		}
	    ...
	    public static void serach3() {
			System.out.println("serach3 begin...");
			...
			System.out.println("serach3 end");
		}
